...
World with a Pioneer robot to illustrate the Sugeno Fuzzy Ruler

Note that that the robot has 16 sonars.
Look at line with sim.robots[0].addDevice(Pioneer16Sonars())
The robot is different from the one use in the assignment on purpose.
